...
describe("forecast reducer", () => {
  ...
  it("should handle get forecast", () => {
    ...
    expect(forecastReducer(initalState, action as IGetForecastAction)).toEqual({
      loading: true,
      data: [],
      error: null,
    });
  ...
  it("should handle get forecast success", () => {
    ...
    expect(
      forecastReducer(initalState, action as IGetForecastSuccessAction)
    ).toEqual({
      loading: false,
      data: [],
      error: null,
  ...
  it("should handle get forecast failure", () => {
    ...
    expect(
      forecastReducer(initalState, action as IGetForecastFailureAction)
    ).toEqual({
      loading: false,
      data: [],
      error: {},
